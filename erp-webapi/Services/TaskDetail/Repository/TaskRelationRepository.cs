...
namespace flexli_erp_webapi.Repository.Interfaces
{
    public class TaskRelationRepository : ITaskRelationRepository
    {
       ...
       // private readonly ISprintRepository _sprintRepository;
        ...
        public TaskRelationRepository( ITaskRepository taskRepository)
        {
        ...
        public List<string> GetTaskIdsForSprint(string sprintId)
        {
            ...
            var sprint = GetSprintByIdFromDb(sprintId);
            if (sprint == null)
            {
                return taskIds;
            }
        ...
        public SprintEditModel GetSprintByIdFromDb (string sprintId)
        {
            using (var db = new ErpContext())
            {
