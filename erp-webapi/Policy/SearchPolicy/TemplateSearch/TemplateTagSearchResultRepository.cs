...
{
    public class TemplateTagSearchResultRepository : ITemplateTagSearchResultRepository
    {
        private readonly ITemplateTagContext _templateTagContext;
        
        public TemplateTagSearchResultRepository(ITemplateTagContext templateTagContext)
        {
        ...
        public async Task<TagTemplateList> GetTemplateListForTag(string keyword)
        {
            ...
            return  await  _templateTagContext
                .TemplateTagSearchResult
                .Find(x => x.Keyword.Contains(keyword.ToLower()))
                .FirstOrDefaultAsync();
        }
